...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height:810px;background-color:rgb(192,197,248);">
        ...
        <div class="widget-container" style="width: 450px; text-align: center; font-size: 22px;
            ...
            margin-left: 5px;">
            Welcome</div>
        <div class="widget-container" style="width: 445px; margin-left: 5px; background-color: White;">
            ...
            <p style="text-align: justify;">
                ...
                methods about communicable diseases.</p>
        </div>
